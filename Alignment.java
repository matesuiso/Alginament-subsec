...
public class Alignment {
 ...
 public String[] cosa (String x, String y) throws Exception{
    String res1 = "";
    String res2 = "";
    ...
    if (y.length() > 0 && x.length() > 0) {
      ...
      if (x.charAt(0) == y.charAt(0)) {
         ...
         String [] tmp = cosa (cortar(x), cortar(y));
         res1 += tmp[0];
         res2 += tmp[1];
